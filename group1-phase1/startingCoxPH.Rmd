...
# FD003 analysis 
library(survival)
plane3 = read.csv('../Data/train_FD003.txt', header=FALSE, sep = ' ')
names(plane3)
drop = c("V27","V28")
...
```{r}
test_plane1 = read.csv('../Data/test_FD001.txt', header=FALSE, sep = ' ')
drop = c("V27","V28", "V1")
test_plane1 = test_plane1[,!(names(test_plane1) %in% drop)]
test_plane2 = read.csv('../Data/test_FD002.txt', header=FALSE, sep = ' ')
test_plane3 = read.csv('../Data/test_FD003.txt', header=FALSE, sep = ' ')
test_plane4 = read.csv('../Data/test_FD004.txt', header=FALSE, sep = ' ')
names(test_plane1) = c('cycles', 'op_setting1', 'op_setting2', 'op_setting3', 's1', 's2', 's3', 's4', 's5', 's6', 's7', 's8', 's9', 's10', 's11', 's12', 's13', 's14', 's15', 's16', 's17', 's18', 's19', 's20', 's21')

options(na.action=na.exclude) # retain NA in predictions

prediction = predict(object = coxph(Surv(time=cycles, event=status)~., data=plane1),newdata=test_plane1, type = "risk" )
#prediction
test_plane1_with_risk <- test_plane1
test_plane1_with_risk <- cbind(test_plane1_with_risk, prediction)
test_plane1_with_risk
